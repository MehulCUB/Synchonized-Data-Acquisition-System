 ...
 * File brief  :  bme280.c
 *
 * I have leveraged code and modified as per requirement and used datastrucre 
 * and functions compensatated value reading related  and for BME280 sensors from of Bosch Sensortec GmbH
 *      Author: mehul
